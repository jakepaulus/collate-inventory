...
function insert(){
if(strlen($_POST['name']) < "3" || strlen($_POST['address']) < "5" || strlen($_POST['city']) < "3" || strlen($_POST['state']) < "2" || strlen($_POST['zip']) < "5" || strlen($_POST['phone']) < "2")
{ $result = "All fields except Alt. Phone and email address are requird. Please go back and try again."; 
require_once('infopage.php'); } else {
